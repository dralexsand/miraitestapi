...
use App\Helpers\DotEnvProcess\AbstractProcess;
use App\Helpers\DotEnvProcess\BooleanProcess;
use App\Helpers\DotEnvProcess\QuotedProcess;
...
class DotEnvReader
{
    ...
    private function setProcessors(array $processors = null): DotEnvReader
    {
        /**
        ...
        foreach ($processors as $processor) {
            if (is_subclass_of($processor, AbstractProcess::class)) {
    ...
    private function processValue(string $value)
    {
        ...
        foreach ($this->processors as $processor) {
            /** @var AbstractProcess $processorInstance */
